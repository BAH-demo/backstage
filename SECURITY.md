...
| V-220631 | Input validation (whitelist approach) | Active |
| V-220632 | Input sanitization (.json() responses, @backstage/errors) | Active |
...
| V-220641 | Security headers and error handling | Active |
...
- **Least privilege access** - Default deny via Backstage permission framework
